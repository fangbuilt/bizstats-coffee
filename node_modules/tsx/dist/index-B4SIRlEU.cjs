"use strict";var Pt=Object.defineProperty;var h=(n,e)=>Pt(n,"name",{value:e,configurable:!0});var Tt=require("node:url"),ie=require("esbuild"),Zt=require("node:crypto"),x=require("node:fs"),Z=require("node:path"),$t=require("node:os"),Vt=require("./temporary-directory-B83uKxJF.cjs");const Je=h(n=>Zt.createHash("sha1").update(n).digest("hex"),"sha1"),Re=44,Wt=59,Ue="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",ve=new Uint8Array(64),xe=new Uint8Array(128);for(let n=0;n<Ue.length;n++){const e=Ue.charCodeAt(n);ve[n]=e,xe[e]=n}const we=typeof TextDecoder<"u"?new TextDecoder:typeof Buffer<"u"?{decode(n){return Buffer.from(n.buffer,n.byteOffset,n.byteLength).toString()}}:{decode(n){let e="";for(let A=0;A<n.length;A++)e+=String.fromCharCode(n[A]);return e}};function zt(n){const e=new Int32Array(5),A=[];let i=0;do{const s=eA(n,i),a=[];let c=!0,C=0;e[0]=0;for(let Q=i;Q<s;Q++){let g;Q=$(n,Q,e,0);const f=e[0];f<C&&(c=!1),C=f,Fe(n,Q,s)?(Q=$(n,Q,e,1),Q=$(n,Q,e,2),Q=$(n,Q,e,3),Fe(n,Q,s)?(Q=$(n,Q,e,4),g=[f,e[1],e[2],e[3],e[4]]):g=[f,e[1],e[2],e[3]]):g=[f],a.push(g)}c||tA(a),A.push(a),i=s+1}while(i<=n.length);return A}h(zt,"decode");function eA(n,e){const A=n.indexOf(";",e);return A===-1?n.length:A}h(eA,"indexOf");function $(n,e,A,i){let s=0,a=0,c=0;do{const Q=n.charCodeAt(e++);c=xe[Q],s|=(c&31)<<a,a+=5}while(c&32);const C=s&1;return s>>>=1,C&&(s=-2147483648|-s),A[i]+=s,e}h($,"decodeInteger");function Fe(n,e,A){return e>=A?!1:n.charCodeAt(e)!==Re}h(Fe,"hasMoreVlq");function tA(n){n.sort(AA)}h(tA,"sort");function AA(n,e){return n[0]-e[0]}h(AA,"sortComparator$1");function Me(n){const e=new Int32Array(5),A=1024*16,i=A-36,s=new Uint8Array(A),a=s.subarray(0,i);let c=0,C="";for(let Q=0;Q<n.length;Q++){const g=n[Q];if(Q>0&&(c===A&&(C+=we.decode(s),c=0),s[c++]=Wt),g.length!==0){e[0]=0;for(let f=0;f<g.length;f++){const r=g[f];c>i&&(C+=we.decode(a),s.copyWithin(0,i,c),c-=i),f>0&&(s[c++]=Re),c=V(s,c,e,r,0),r.length!==1&&(c=V(s,c,e,r,1),c=V(s,c,e,r,2),c=V(s,c,e,r,3),r.length!==4&&(c=V(s,c,e,r,4)))}}}return C+we.decode(s.subarray(0,c))}h(Me,"encode");function V(n,e,A,i,s){const a=i[s];let c=a-A[s];A[s]=a,c=c<0?-c<<1|1:c<<1;do{let C=c&31;c>>>=5,c>0&&(C|=32),n[e++]=ve[C]}while(c>0);return e}h(V,"encodeInteger");class ce{static{h(this,"BitSet")}constructor(e){this.bits=e instanceof ce?e.bits.slice():[]}add(e){this.bits[e>>5]|=1<<(e&31)}has(e){return!!(this.bits[e>>5]&1<<(e&31))}}class te{static{h(this,"Chunk")}constructor(e,A,i){this.start=e,this.end=A,this.original=i,this.intro="",this.outro="",this.content=i,this.storeName=!1,this.edited=!1,this.previous=null,this.next=null}appendLeft(e){this.outro+=e}appendRight(e){this.intro=this.intro+e}clone(){const e=new te(this.start,this.end,this.original);return e.intro=this.intro,e.outro=this.outro,e.content=this.content,e.storeName=this.storeName,e.edited=this.edited,e}contains(e){return this.start<e&&e<this.end}eachNext(e){let A=this;for(;A;)e(A),A=A.next}eachPrevious(e){let A=this;for(;A;)e(A),A=A.previous}edit(e,A,i){return this.content=e,i||(this.intro="",this.outro=""),this.storeName=A,this.edited=!0,this}prependLeft(e){this.outro=e+this.outro}prependRight(e){this.intro=e+this.intro}reset(){this.intro="",this.outro="",this.edited&&(this.content=this.original,this.storeName=!1,this.edited=!1)}split(e){const A=e-this.start,i=this.original.slice(0,A),s=this.original.slice(A);this.original=i;const a=new te(e,this.end,s);return a.outro=this.outro,this.outro="",this.end=e,this.edited?(a.edit("",!1),this.content=""):this.content=i,a.next=this.next,a.next&&(a.next.previous=a),a.previous=this,this.next=a,a}toString(){return this.intro+this.content+this.outro}trimEnd(e){if(this.outro=this.outro.replace(e,""),this.outro.length)return!0;const A=this.content.replace(e,"");if(A.length)return A!==this.content&&(this.split(this.start+A.length).edit("",void 0,!0),this.edited&&this.edit(A,this.storeName,!0)),!0;if(this.edit("",void 0,!0),this.intro=this.intro.replace(e,""),this.intro.length)return!0}trimStart(e){if(this.intro=this.intro.replace(e,""),this.intro.length)return!0;const A=this.content.replace(e,"");if(A.length){if(A!==this.content){const i=this.split(this.end-A.length);this.edited&&i.edit(A,this.storeName,!0),this.edit("",void 0,!0)}return!0}else if(this.edit("",void 0,!0),this.outro=this.outro.replace(e,""),this.outro.length)return!0}}function rA(){return typeof globalThis<"u"&&typeof globalThis.btoa=="function"?n=>globalThis.btoa(unescape(encodeURIComponent(n))):typeof Buffer=="function"?n=>Buffer.from(n,"utf-8").toString("base64"):()=>{throw new Error("Unsupported environment: `window.btoa` or `Buffer` should be supported.")}}h(rA,"getBtoa");const iA=rA();let nA=class{static{h(this,"SourceMap")}constructor(e){this.version=3,this.file=e.file,this.sources=e.sources,this.sourcesContent=e.sourcesContent,this.names=e.names,this.mappings=Me(e.mappings),typeof e.x_google_ignoreList<"u"&&(this.x_google_ignoreList=e.x_google_ignoreList)}toString(){return JSON.stringify(this)}toUrl(){return"data:application/json;charset=utf-8;base64,"+iA(this.toString())}};function sA(n){const e=n.split(`
`),A=e.filter(a=>/^\t+/.test(a)),i=e.filter(a=>/^ {2,}/.test(a));if(A.length===0&&i.length===0)return null;if(A.length>=i.length)return"	";const s=i.reduce((a,c)=>{const C=/^ +/.exec(c)[0].length;return Math.min(C,a)},1/0);return new Array(s+1).join(" ")}h(sA,"guessIndent");function oA(n,e){const A=n.split(/[/\\]/),i=e.split(/[/\\]/);for(A.pop();A[0]===i[0];)A.shift(),i.shift();if(A.length){let s=A.length;for(;s--;)A[s]=".."}return A.concat(i).join("/")}h(oA,"getRelativePath");const aA=Object.prototype.toString;function cA(n){return aA.call(n)==="[object Object]"}h(cA,"isObject");function Ge(n){const e=n.split(`
`),A=[];for(let i=0,s=0;i<e.length;i++)A.push(s),s+=e[i].length+1;return h(function(s){let a=0,c=A.length;for(;a<c;){const g=a+c>>1;s<A[g]?c=g:a=g+1}const C=a-1,Q=s-A[C];return{line:C,column:Q}},"locate")}h(Ge,"getLocator");const uA=/\w/;class lA{static{h(this,"Mappings")}constructor(e){this.hires=e,this.generatedCodeLine=0,this.generatedCodeColumn=0,this.raw=[],this.rawSegments=this.raw[this.generatedCodeLine]=[],this.pending=null}addEdit(e,A,i,s){if(A.length){const a=A.length-1;let c=A.indexOf(`
...
`,O={insertLeft:!1,insertRight:!1,storeName:!1};class De{static{h(this,"MagicString")}constructor(e,A={}){const i=new te(0,e.length,e);Object.defineProperties(this,{original:{writable:!0,value:e},outro:{writable:!0,value:""},intro:{writable:!0,value:""},firstChunk:{writable:!0,value:i},lastChunk:{writable:!0,value:i},lastSearchedChunk:{writable:!0,value:i},byStart:{writable:!0,value:{}},byEnd:{writable:!0,value:{}},filename:{writable:!0,value:A.filename},indentExclusionRanges:{writable:!0,value:A.indentExclusionRanges},sourcemapLocations:{writable:!0,value:new ce},storedNames:{writable:!0,value:{}},indentStr:{writable:!0,value:void 0},ignoreList:{writable:!0,value:A.ignoreList}}),this.byStart[0]=i,this.byEnd[e.length]=i}addSourcemapLocation(e){this.sourcemapLocations.add(e)}append(e){if(typeof e!="string")throw new TypeError("outro content must be a string");return this.outro+=e,this}appendLeft(e,A){if(typeof A!="string")throw new TypeError("inserted content must be a string");this._split(e);const i=this.byEnd[e];return i?i.appendLeft(A):this.intro+=A,this}appendRight(e,A){if(typeof A!="string")throw new TypeError("inserted content must be a string");this._split(e);const i=this.byStart[e];return i?i.appendRight(A):this.outro+=A,this}clone(){const e=new De(this.original,{filename:this.filename});let A=this.firstChunk,i=e.firstChunk=e.lastSearchedChunk=A.clone();for(;A;){e.byStart[i.start]=i,e.byEnd[i.end]=i;const s=A.next,a=s&&s.clone();a&&(i.next=a,a.previous=i,i=a),A=s}return e.lastChunk=i,this.indentExclusionRanges&&(e.indentExclusionRanges=this.indentExclusionRanges.slice()),e.sourcemapLocations=new ce(this.sourcemapLocations),e.intro=this.intro,e.outro=this.outro,e}generateDecodedMap(e){e=e||{};const A=0,i=Object.keys(this.storedNames),s=new lA(e.hires),a=Ge(this.original);return this.intro&&s.advance(this.intro),this.firstChunk.eachNext(c=>{const C=a(c.start);c.intro.length&&s.advance(c.intro),c.edited?s.addEdit(A,c.content,C,c.storeName?i.indexOf(c.original):-1):s.addUneditedChunk(A,c,this.original,C,this.sourcemapLocations),c.outro.length&&s.advance(c.outro)}),{file:e.file?e.file.split(/[/\\]/).pop():void 0,sources:[e.source?oA(e.file||"",e.source):e.file||""],sourcesContent:e.includeContent?[this.original]:void 0,names:i,mappings:s.raw,x_google_ignoreList:this.ignoreList?[A]:void 0}}generateMap(e){return new nA(this.generateDecodedMap(e))}_ensureindentStr(){this.indentStr===void 0&&(this.indentStr=sA(this.original))}_getRawIndentString(){return this._ensureindentStr(),this.indentStr}getIndentString(){return this._ensureindentStr(),this.indentStr===null?"	":this.indentStr}indent(e,A){const i=/^[^\r\n]/gm;if(cA(e)&&(A=e,e=void 0),e===void 0&&(this._ensureindentStr(),e=this.indentStr||"	"),e==="")return this;A=A||{};const s={};A.exclude&&(typeof A.exclude[0]=="number"?[A.exclude]:A.exclude).forEach(f=>{for(let r=f[0];r<f[1];r+=1)s[r]=!0});let a=A.indentStart!==!1;const c=h(g=>a?`${e}${g}`:(a=!0,g),"replacer");this.intro=this.intro.replace(i,c);let C=0,Q=this.firstChunk;for(;Q;){const g=Q.end;if(Q.edited)s[C]||(Q.content=Q.content.replace(i,c),Q.content.length&&(a=Q.content[Q.content.length-1]===`
`));else for(C=Q.start;C<g;){if(!s[C]){const f=this.original[C];f===`
`?a=!0:f!=="\r"&&a&&(a=!1,C===Q.start||(this._splitChunk(Q,C),Q=Q.next),Q.prependRight(e))}C+=1}C=Q.end,Q=Q.next}return this.outro=this.outro.replace(i,c),this}insert(){throw new Error("magicString.insert(...) is deprecated. Use prependRight(...) or appendLeft(...)")}insertLeft(e,A){return O.insertLeft||(console.warn("magicString.insertLeft(...) is deprecated. Use magicString.appendLeft(...) instead"),O.insertLeft=!0),this.appendLeft(e,A)}insertRight(e,A){return O.insertRight||(console.warn("magicString.insertRight(...) is deprecated. Use magicString.prependRight(...) instead"),O.insertRight=!0),this.prependRight(e,A)}move(e,A,i){if(i>=e&&i<=A)throw new Error("Cannot move a selection inside itself");this._split(e),this._split(A),this._split(i);const s=this.byStart[e],a=this.byEnd[A],c=s.previous,C=a.next,Q=this.byStart[i];if(!Q&&a===this.lastChunk)return this;const g=Q?Q.previous:this.lastChunk;return c&&(c.next=C),C&&(C.previous=c),g&&(g.next=s),Q&&(Q.previous=a),s.previous||(this.firstChunk=a.next),a.next||(this.lastChunk=s.previous,this.lastChunk.next=null),s.previous=g,a.next=Q||null,g||(this.firstChunk=s),Q||(this.lastChunk=a),this}overwrite(e,A,i,s){return s=s||{},this.update(e,A,i,{...s,overwrite:!s.contentOnly})}update(e,A,i,s){if(typeof i!="string")throw new TypeError("replacement content must be a string");for(;e<0;)e+=this.original.length;for(;A<0;)A+=this.original.length;if(A>this.original.length)throw new Error("end is out of bounds");if(e===A)throw new Error("Cannot overwrite a zero-length range \u2013 use appendLeft or prependRight instead");this._split(e),this._split(A),s===!0&&(O.storeName||(console.warn("The final argument to magicString.overwrite(...) should be an options object. See https://github.com/rich-harris/magic-string"),O.storeName=!0),s={storeName:!0});const a=s!==void 0?s.storeName:!1,c=s!==void 0?s.overwrite:!1;if(a){const g=this.original.slice(e,A);Object.defineProperty(this.storedNames,g,{writable:!0,value:!0,enumerable:!0})}const C=this.byStart[e],Q=this.byEnd[A];if(C){let g=C;for(;g!==Q;){if(g.next!==this.byStart[g.end])throw new Error("Cannot overwrite across a split point");g=g.next,g.edit("",!1)}C.edit(i,a,!c)}else{const g=new te(e,A,"").edit(i,a);Q.next=g,g.previous=Q}return this}prepend(e){if(typeof e!="string")throw new TypeError("outro content must be a string");return this.intro=e+this.intro,this}prependLeft(e,A){if(typeof A!="string")throw new TypeError("inserted content must be a string");this._split(e);const i=this.byEnd[e];return i?i.prependLeft(A):this.intro=A+this.intro,this}prependRight(e,A){if(typeof A!="string")throw new TypeError("inserted content must be a string");this._split(e);const i=this.byStart[e];return i?i.prependRight(A):this.outro=A+this.outro,this}remove(e,A){for(;e<0;)e+=this.original.length;for(;A<0;)A+=this.original.length;if(e===A)return this;if(e<0||A>this.original.length)throw new Error("Character is out of bounds");if(e>A)throw new Error("end must be greater than start");this._split(e),this._split(A);let i=this.byStart[e];for(;i;)i.intro="",i.outro="",i.edit(""),i=A>i.end?this.byStart[i.end]:null;return this}reset(e,A){for(;e<0;)e+=this.original.length;for(;A<0;)A+=this.original.length;if(e===A)return this;if(e<0||A>this.original.length)throw new Error("Character is out of bounds");if(e>A)throw new Error("end must be greater than start");this._split(e),this._split(A);let i=this.byStart[e];for(;i;)i.reset(),i=A>i.end?this.byStart[i.end]:null;return this}lastChar(){if(this.outro.length)return this.outro[this.outro.length-1];let e=this.lastChunk;do{if(e.outro.length)return e.outro[e.outro.length-1];if(e.content.length)return e.content[e.content.length-1];if(e.intro.length)return e.intro[e.intro.length-1]}while(e=e.previous);return this.intro.length?this.intro[this.intro.length-1]:""}lastLine(){let e=this.outro.lastIndexOf(W);if(e!==-1)return this.outro.substr(e+1);let A=this.outro,i=this.lastChunk;do{if(i.outro.length>0){if(e=i.outro.lastIndexOf(W),e!==-1)return i.outro.substr(e+1)+A;A=i.outro+A}if(i.content.length>0){if(e=i.content.lastIndexOf(W),e!==-1)return i.content.substr(e+1)+A;A=i.content+A}if(i.intro.length>0){if(e=i.intro.lastIndexOf(W),e!==-1)return i.intro.substr(e+1)+A;A=i.intro+A}}while(i=i.previous);return e=this.intro.lastIndexOf(W),e!==-1?this.intro.substr(e+1)+A:this.intro+A}slice(e=0,A=this.original.length){for(;e<0;)e+=this.original.length;for(;A<0;)A+=this.original.length;let i="",s=this.firstChunk;for(;s&&(s.start>e||s.end<=e);){if(s.start<A&&s.end>=A)return i;s=s.next}if(s&&s.edited&&s.start!==e)throw new Error(`Cannot use replaced character ${e} as slice start anchor.`);const a=s;for(;s;){s.intro&&(a!==s||s.start===e)&&(i+=s.intro);const c=s.start<A&&s.end>=A;if(c&&s.edited&&s.end!==A)throw new Error(`Cannot use replaced character ${A} as slice end anchor.`);const C=a===s?e-s.start:0,Q=c?s.content.length+A-s.end:s.content.length;if(i+=s.content.slice(C,Q),s.outro&&(!c||s.end===A)&&(i+=s.outro),c)break;s=s.next}return i}snip(e,A){const i=this.clone();return i.remove(0,e),i.remove(A,i.original.length),i}_split(e){if(this.byStart[e]||this.byEnd[e])return;let A=this.lastSearchedChunk;const i=e>A.end;for(;A;){if(A.contains(e))return this._splitChunk(A,e);A=i?this.byStart[A.end]:this.byEnd[A.start]}}_splitChunk(e,A){if(e.edited&&e.content.length){const s=Ge(this.original)(A);throw new Error(`Cannot split a chunk that has already been edited (${s.line}:${s.column} \u2013 "${e.original}")`)}const i=e.split(A);return this.byEnd[A]=e,this.byStart[A]=i,this.byEnd[i.end]=i,e===this.lastChunk&&(this.lastChunk=i),this.lastSearchedChunk=e,!0}toString(){let e=this.intro,A=this.firstChunk;for(;A;)e+=A.toString(),A=A.next;return e+this.outro}isEmpty(){let e=this.firstChunk;do if(e.intro.length&&e.intro.trim()||e.content.length&&e.content.trim()||e.outro.length&&e.outro.trim())return!1;while(e=e.next);return!0}length(){let e=this.firstChunk,A=0;do A+=e.intro.length+e.content.length+e.outro.length;while(e=e.next);return A}trimLines(){return this.trim("[\\r\\n]")}trim(e){return this.trimStart(e).trimEnd(e)}trimEndAborted(e){const A=new RegExp((e||"\\s")+"+$");if(this.outro=this.outro.replace(A,""),this.outro.length)return!0;let i=this.lastChunk;do{const s=i.end,a=i.trimEnd(A);if(i.end!==s&&(this.lastChunk===i&&(this.lastChunk=i.next),this.byEnd[i.end]=i,this.byStart[i.next.start]=i.next,this.byEnd[i.next.end]=i.next),a)return!0;i=i.previous}while(i);return!1}trimEnd(e){return this.trimEndAborted(e),this}trimStartAborted(e){const A=new RegExp("^"+(e||"\\s")+"+");if(this.intro=this.intro.replace(A,""),this.intro.length)return!0;let i=this.firstChunk;do{const s=i.end,a=i.trimStart(A);if(i.end!==s&&(i===this.lastChunk&&(this.lastChunk=i.next),this.byEnd[i.end]=i,this.byStart[i.next.start]=i.next,this.byEnd[i.next.end]=i.next),a)return!0;i=i.next}while(i);return!1}trimStart(e){return this.trimStartAborted(e),this}hasChanged(){return this.original!==this.toString()}_replaceRegexp(e,A){function i(a,c){return typeof A=="string"?A.replace(/\$(\$|&|\d+)/g,(C,Q)=>Q==="$"?"$":Q==="&"?a[0]:+Q<a.length?a[+Q]:`$${Q}`):A(...a,a.index,c,a.groups)}h(i,"getReplacement");function s(a,c){let C;const Q=[];for(;C=a.exec(c);)Q.push(C);return Q}if(h(s,"matchAll"),e.global)s(e,this.original).forEach(c=>{if(c.index!=null){const C=i(c,this.original);C!==c[0]&&this.overwrite(c.index,c.index+c[0].length,C)}});else{const a=this.original.match(e);if(a&&a.index!=null){const c=i(a,this.original);c!==a[0]&&this.overwrite(a.index,a.index+a[0].length,c)}}return this}_replaceString(e,A){const{original:i}=this,s=i.indexOf(e);return s!==-1&&this.overwrite(s,s+e.length,A),this}replace(e,A){return typeof e=="string"?this._replaceString(e,A):this._replaceRegexp(e,A)}_replaceAllString(e,A){const{original:i}=this,s=e.length;for(let a=i.indexOf(e);a!==-1;a=i.indexOf(e,a+s))i.slice(a,a+s)!==A&&this.overwrite(a,a+s,A);return this}replaceAll(e,A){if(typeof e=="string")return this._replaceAllString(e,A);if(!e.global)throw new TypeError("MagicString.prototype.replaceAll called with a non-global RegExp argument");return this._replaceRegexp(e,A)}}var Ye;(function(n){n[n.Static=1]="Static",n[n.Dynamic=2]="Dynamic",n[n.ImportMeta=3]="ImportMeta",n[n.StaticSourcePhase=4]="StaticSourcePhase",n[n.DynamicSourcePhase=5]="DynamicSourcePhase"})(Ye||(Ye={}));const hA=new Uint8Array(new Uint16Array([1]).buffer)[0]===1;function He(n,e="@"){if(!w)return qe.then(()=>He(n));const A=n.length+1,i=(w.__heap_base.value||w.__heap_base)+4*A-w.memory.buffer.byteLength;i>0&&w.memory.grow(Math.ceil(i/65536));const s=w.sa(A-1);if((hA?QA:fA)(n,new Uint16Array(w.memory.buffer,s,A)),!w.parse())throw Object.assign(new Error(`Parse error ${e}:${n.slice(0,w.e()).split(`
`).length}:${w.e()-n.lastIndexOf(`
`,w.e()-1)}`),{idx:w.e()});const a=[],c=[];for(;w.ri();){const Q=w.is(),g=w.ie(),f=w.it(),r=w.ai(),m=w.id(),K=w.ss(),p=w.se();let S;w.ip()&&(S=C(n.slice(m===-1?Q-1:Q,m===-1?g+1:g))),a.push({n:S,t:f,s:Q,e:g,ss:K,se:p,d:m,a:r})}for(;w.re();){const Q=w.es(),g=w.ee(),f=w.els(),r=w.ele(),m=n.slice(Q,g),K=m[0],p=f<0?void 0:n.slice(f,r),S=p?p[0]:"";c.push({s:Q,e:g,ls:f,le:r,n:K==='"'||K==="'"?C(m):m,ln:S==='"'||S==="'"?C(p):p})}function C(Q){try{return(0,eval)(Q)}catch{}}return h(C,"k"),[a,c,!!w.f(),!!w.ms()]}h(He,"parse$1");function fA(n,e){const A=n.length;let i=0;for(;i<A;){const s=n.charCodeAt(i);e[i++]=(255&s)<<8|s>>>8}}h(fA,"Q");function QA(n,e){const A=n.length;let i=0;for(;i<A;)e[i]=n.charCodeAt(i++)}h(QA,"B");let w;const qe=WebAssembly.compile((ke="",typeof Buffer<"u"?Buffer.from(ke,"base64"):Uint8Array.from(atob(ke),n=>n.charCodeAt(0)))).then(WebAssembly.instantiate).then(({exports:n})=>{w=n});var ke;let y,ne,Ie,z=2<<19;const _e=new Uint8Array(new Uint16Array([1]).buffer)[0]===1?function(n,e){const A=n.length;let i=0;for(;i<A;)e[i]=n.charCodeAt(i++)}:function(n,e){const A=n.length;let i=0;for(;i<A;){const s=n.charCodeAt(i);e[i++]=(255&s)<<8|s>>>8}},gA="xportmportlassforetaourceromsyncunctionssertvoyiedelecontininstantybreareturdebuggeawaithrwhileifcatcfinallels";let L,Oe,k;function CA(n,e="@"){L=n,Oe=e;const A=2*L.length+(2<<18);if(A>z||!y){for(;A>z;)z*=2;ne=new ArrayBuffer(z),_e(gA,new Uint16Array(ne,16,110)),y=function(c,C,Q){var g=new c.Int8Array(Q),f=new c.Int16Array(Q),r=new c.Int32Array(Q),m=new c.Uint8Array(Q),K=new c.Uint16Array(Q),p=1040;function S(){var t=0,o=0,l=0,u=0,E=0,B=0,I=0;I=p,p=p+10240|0,g[804]=1,g[803]=0,f[399]=0,f[400]=0,r[69]=r[2],g[805]=0,r[68]=0,g[802]=0,r[70]=I+2048,r[71]=I,g[806]=0,t=(r[3]|0)+-2|0,r[72]=t,o=t+(r[66]<<1)|0,r[73]=o;e:for(;;){if(l=t+2|0,r[72]=l,t>>>0>=o>>>0){u=18;break}t:do switch(f[l>>1]|0){case 9:case 10:case 11:case 12:case 13:case 32:break;case 101:{if(!(f[400]|0)&&P(l)|0&&!(J(t+4|0,16,10)|0)&&(v(),(g[804]|0)==0)){u=9;break e}else u=17;break}case 105:{P(l)|0&&!(J(t+4|0,26,10)|0)&&H(),u=17;break}case 59:{u=17;break}case 47:switch(f[t+4>>1]|0){case 47:{Qe();break t}case 42:{he(1);break t}default:{u=16;break e}}default:{u=16;break e}}while(!1);(u|0)==17&&(u=0,r[69]=r[72]),t=r[72]|0,o=r[73]|0}(u|0)==9?(t=r[72]|0,r[69]=t,u=19):(u|0)==16?(g[804]=0,r[72]=t,u=19):(u|0)==18&&(g[802]|0?t=0:(t=l,u=19));do if((u|0)==19){e:for(;;){if(o=t+2|0,r[72]=o,t>>>0>=(r[73]|0)>>>0){u=92;break}t:do switch(f[o>>1]|0){case 9:case 10:case 11:case 12:case 13:case 32:break;case 101:{!(f[400]|0)&&P(o)|0&&!(J(t+4|0,16,10)|0)&&v(),u=91;break}case 105:{P(o)|0&&!(J(t+4|0,26,10)|0)&&H(),u=91;break}case 99:{P(o)|0&&!(J(t+4|0,36,8)|0)&&_(f[t+12>>1]|0)|0&&(g[806]=1),u=91;break}case 40:{l=r[70]|0,t=f[400]|0,u=t&65535,r[l+(u<<3)>>2]=1,o=r[69]|0,f[400]=t+1<<16>>16,r[l+(u<<3)+4>>2]=o,u=91;break}case 41:{if(o=f[400]|0,!(o<<16>>16)){u=36;break e}l=o+-1<<16>>16,f[400]=l,u=f[399]|0,o=u&65535,u<<16>>16&&(r[(r[70]|0)+((l&65535)<<3)>>2]|0)==5&&(o=r[(r[71]|0)+(o+-1<<2)>>2]|0,l=o+4|0,r[l>>2]|0||(r[l>>2]=(r[69]|0)+2),r[o+12>>2]=t+4,f[399]=u+-1<<16>>16),u=91;break}case 123:{u=r[69]|0,l=r[63]|0,t=u;do if((f[u>>1]|0)==41&(l|0)!=0&&(r[l+4>>2]|0)==(u|0))if(o=r[64]|0,r[63]=o,o){r[o+32>>2]=0;break}else{r[59]=0;break}while(!1);l=r[70]|0,o=f[400]|0,u=o&65535,r[l+(u<<3)>>2]=g[806]|0?6:2,f[400]=o+1<<16>>16,r[l+(u<<3)+4>>2]=t,g[806]=0,u=91;break}case 125:{if(t=f[400]|0,!(t<<16>>16)){u=49;break e}l=r[70]|0,u=t+-1<<16>>16,f[400]=u,(r[l+((u&65535)<<3)>>2]|0)==4&&ye(),u=91;break}case 39:{R(39),u=91;break}case 34:{R(34),u=91;break}case 47:switch(f[t+4>>1]|0){case 47:{Qe();break t}case 42:{he(1);break t}default:{t=r[69]|0,o=f[t>>1]|0;A:do if(!(bt(o)|0))o<<16>>16==41?(l=f[400]|0,yt(r[(r[70]|0)+((l&65535)<<3)+4>>2]|0)|0||(u=65)):u=64;else switch(o<<16>>16){case 46:if(((f[t+-2>>1]|0)+-48&65535)<10){u=64;break A}else break A;case 43:if((f[t+-2>>1]|0)==43){u=64;break A}else break A;case 45:if((f[t+-2>>1]|0)==45){u=64;break A}else break A;default:break A}while(!1);(u|0)==64&&(l=f[400]|0,u=65);A:do if((u|0)==65){if(u=0,l<<16>>16&&(E=r[70]|0,B=(l&65535)+-1|0,o<<16>>16==102?(r[E+(B<<3)>>2]|0)==1:0)){if((f[t+-2>>1]|0)==111&&N(r[E+(B<<3)+4>>2]|0,44,3)|0)break}else u=69;if((u|0)==69&&o<<16>>16==125&&(u=r[70]|0,l=l&65535,pt(r[u+(l<<3)+4>>2]|0)|0||(r[u+(l<<3)>>2]|0)==6))break;if(!(kt(t)|0)){switch(o<<16>>16){case 0:break A;case 47:{if(g[805]|0)break A;break}default:}if(u=r[65]|0,u|0&&t>>>0>=(r[u>>2]|0)>>>0&&t>>>0<=(r[u+4>>2]|0)>>>0){le(),g[805]=0,u=91;break t}l=r[3]|0;do{if(t>>>0<=l>>>0)break;t=t+-2|0,r[69]=t,o=f[t>>1]|0}while(!(fe(o)|0));if(re(o)|0){do{if(t>>>0<=l>>>0)break;t=t+-2|0,r[69]=t}while(re(f[t>>1]|0)|0);if(Kt(t)|0){le(),g[805]=0,u=91;break t}}g[805]=1,u=91;break t}}while(!1);le(),g[805]=0,u=91;break t}}case 96:{l=r[70]|0,o=f[400]|0,u=o&65535,r[l+(u<<3)+4>>2]=r[69],f[400]=o+1<<16>>16,r[l+(u<<3)>>2]=3,ye(),u=91;break}default:u=91}while(!1);(u|0)==91&&(u=0,r[69]=r[72]),t=r[72]|0}if((u|0)==36){U(),t=0;break}else if((u|0)==49){U(),t=0;break}else if((u|0)==92){t=g[802]|0?0:(f[399]|f[400])<<16>>16==0;break}}while(!1);return p=I,t|0}h(S,"b");function v(){var t=0,o=0,l=0,u=0,E=0,B=0,I=0,G=0,Ce=0,Ee=0,Be=0,de=0,b=0,D=0;G=r[72]|0,Ce=r[65]|0,D=G+12|0,r[72]=D,l=d(1)|0,t=r[72]|0,(t|0)==(D|0)&&!(Ae(l)|0)||(b=3);e:do if((b|0)==3){t:do switch(l<<16>>16){case 123:{for(r[72]=t+2,t=d(1)|0,o=r[72]|0;;){if(T(t)|0?(R(t),t=(r[72]|0)+2|0,r[72]=t):(F(t)|0,t=r[72]|0),d(1)|0,t=Le(o,t)|0,t<<16>>16==44&&(r[72]=(r[72]|0)+2,t=d(1)|0),t<<16>>16==125){b=15;break}if(D=o,o=r[72]|0,(o|0)==(D|0)){b=12;break}if(o>>>0>(r[73]|0)>>>0){b=14;break}}if((b|0)==12){U();break e}else if((b|0)==14){U();break e}else if((b|0)==15){g[803]=1,r[72]=(r[72]|0)+2;break t}break}case 42:{r[72]=t+2,d(1)|0,D=r[72]|0,Le(D,D)|0;break}default:{switch(g[804]=0,l<<16>>16){case 100:{switch(G=t+14|0,r[72]=G,(d(1)|0)<<16>>16){case 97:{o=r[72]|0,!(J(o+2|0,72,8)|0)&&(E=o+10|0,re(f[E>>1]|0)|0)&&(r[72]=E,d(0)|0,b=22);break}case 102:{b=22;break}case 99:{o=r[72]|0,!(J(o+2|0,36,8)|0)&&(u=o+10|0,D=f[u>>1]|0,_(D)|0|D<<16>>16==123)&&(r[72]=u,B=d(1)|0,B<<16>>16!=123)&&(de=B,b=31);break}default:}A:do if((b|0)==22&&(I=r[72]|0,(J(I+2|0,80,14)|0)==0)){if(l=I+16|0,o=f[l>>1]|0,!(_(o)|0))switch(o<<16>>16){case 40:case 42:break;default:break A}r[72]=l,o=d(1)|0,o<<16>>16==42&&(r[72]=(r[72]|0)+2,o=d(1)|0),o<<16>>16!=40&&(de=o,b=31)}while(!1);if((b|0)==31&&(Ee=r[72]|0,F(de)|0,Be=r[72]|0,Be>>>0>Ee>>>0)){q(t,G,Ee,Be),r[72]=(r[72]|0)+-2;break e}q(t,G,0,0),r[72]=t+12;break e}case 97:{r[72]=t+10,d(0)|0,t=r[72]|0,b=35;break}case 102:{b=35;break}case 99:{if(!(J(t+2|0,36,8)|0)&&(o=t+10|0,fe(f[o>>1]|0)|0)){r[72]=o,D=d(1)|0,b=r[72]|0,F(D)|0,D=r[72]|0,q(b,D,b,D),r[72]=(r[72]|0)+-2;break e}t=t+4|0,r[72]=t;break}case 108:case 118:break;default:break e}if((b|0)==35){r[72]=t+16,t=d(1)|0,t<<16>>16==42&&(r[72]=(r[72]|0)+2,t=d(1)|0),b=r[72]|0,F(t)|0,D=r[72]|0,q(b,D,b,D),r[72]=(r[72]|0)+-2;break e}r[72]=t+6,g[804]=0,l=d(1)|0,t=r[72]|0,l=(F(l)|0|32)<<16>>16==123,u=r[72]|0,l&&(r[72]=u+2,D=d(1)|0,t=r[72]|0,F(D)|0);A:for(;o=r[72]|0,(o|0)!=(t|0);){if(q(t,o,t,o),o=d(1)|0,l)switch(o<<16>>16){case 93:case 125:break e;default:}if(t=r[72]|0,o<<16>>16!=44){b=51;break}switch(r[72]=t+2,o=d(1)|0,t=r[72]|0,o<<16>>16){case 91:case 123:{b=51;break A}default:}F(o)|0}if((b|0)==51&&(r[72]=t+-2),!l)break e;r[72]=u+-2;break e}}while(!1);if(D=(d(1)|0)<<16>>16==102,t=r[72]|0,D&&!(J(t+2|0,66,6)|0))for(r[72]=t+8,j(G,d(1)|0,0),t=Ce|0?Ce+16|0:240;;){if(t=r[t>>2]|0,!t)break e;r[t+12>>2]=0,r[t+8>>2]=0,t=t+16|0}r[72]=t+-2}while(!1)}h(v,"k");function H(){var t=0,o=0,l=0,u=0,E=0,B=0,I=0;E=r[72]|0,l=E+12|0,r[72]=l,u=d(1)|0,o=r[72]|0;e:do if(u<<16>>16!=46)u<<16>>16==115&o>>>0>l>>>0?!(J(o+2|0,56,10)|0)&&(t=o+12|0,_(f[t>>1]|0)|0)?B=14:(o=6,l=0,B=46):(t=u,l=0,B=15);else switch(r[72]=o+2,(d(1)|0)<<16>>16){case 109:{if(t=r[72]|0,J(t+2|0,50,6)|0||(o=r[69]|0,!(ge(o)|0)&&(f[o>>1]|0)==46))break e;ue(E,E,t+8|0,2);break e}case 115:{if(t=r[72]|0,J(t+2|0,56,10)|0||(o=r[69]|0,!(ge(o)|0)&&(f[o>>1]|0)==46))break e;t=t+12|0,B=14;break e}default:break e}while(!1);(B|0)==14&&(r[72]=t,t=d(1)|0,l=1,B=15);e:do if((B|0)==15)switch(t<<16>>16){case 40:{if(o=r[70]|0,I=f[400]|0,u=I&65535,r[o+(u<<3)>>2]=5,t=r[72]|0,f[400]=I+1<<16>>16,r[o+(u<<3)+4>>2]=t,(f[r[69]>>1]|0)==46)break e;switch(r[72]=t+2,o=d(1)|0,ue(E,r[72]|0,0,t),l?(t=r[63]|0,r[t+28>>2]=5):t=r[63]|0,E=r[71]|0,I=f[399]|0,f[399]=I+1<<16>>16,r[E+((I&65535)<<2)>>2]=t,o<<16>>16){case 39:{R(39);break}case 34:{R(34);break}default:{r[72]=(r[72]|0)+-2;break e}}switch(t=(r[72]|0)+2|0,r[72]=t,(d(1)|0)<<16>>16){case 44:{r[72]=(r[72]|0)+2,d(1)|0,E=r[63]|0,r[E+4>>2]=t,I=r[72]|0,r[E+16>>2]=I,g[E+24>>0]=1,r[72]=I+-2;break e}case 41:{f[400]=(f[400]|0)+-1<<16>>16,I=r[63]|0,r[I+4>>2]=t,r[I+12>>2]=(r[72]|0)+2,g[I+24>>0]=1,f[399]=(f[399]|0)+-1<<16>>16;break e}default:{r[72]=(r[72]|0)+-2;break e}}}case 123:{if(l){o=12,l=1,B=46;break e}if(t=r[72]|0,f[400]|0){r[72]=t+-2;break e}for(;!(t>>>0>=(r[73]|0)>>>0);){if(t=d(1)|0,T(t)|0)R(t);else if(t<<16>>16==125){B=36;break}t=(r[72]|0)+2|0,r[72]=t}if((B|0)==36&&(r[72]=(r[72]|0)+2),I=(d(1)|0)<<16>>16==102,t=r[72]|0,I&&J(t+2|0,66,6)|0){U();break e}if(r[72]=t+8,t=d(1)|0,T(t)|0){j(E,t,0);break e}else{U();break e}}default:{if(l){o=12,l=1,B=46;break e}switch(t<<16>>16){case 42:case 39:case 34:{l=0,B=48;break e}default:{o=6,l=0,B=46;break e}}}}while(!1);(B|0)==46&&(t=r[72]|0,(t|0)==(E+(o<<1)|0)?r[72]=t+-2:B=48);do if((B|0)==48){if(f[400]|0){r[72]=(r[72]|0)+-2;break}for(t=r[73]|0,o=r[72]|0;;){if(o>>>0>=t>>>0){B=55;break}if(u=f[o>>1]|0,T(u)|0){B=53;break}I=o+2|0,r[72]=I,o=I}if((B|0)==53){j(E,u,l);break}else if((B|0)==55){U();break}}while(!1)}h(H,"l");function j(t,o,l){t=t|0,o=o|0,l=l|0;var u=0,E=0;switch(u=(r[72]|0)+2|0,o<<16>>16){case 39:{R(39),E=5;break}case 34:{R(34),E=5;break}default:U()}do if((E|0)==5){if(ue(t,u,r[72]|0,1),l&&(r[(r[63]|0)+28>>2]=4),r[72]=(r[72]|0)+2,o=d(0)|0,l=o<<16>>16==97,l?(u=r[72]|0,J(u+2|0,94,10)|0&&(E=13)):(u=r[72]|0,o<<16>>16==119&&(f[u+2>>1]|0)==105&&(f[u+4>>1]|0)==116&&(f[u+6>>1]|0)==104||(E=13)),(E|0)==13){r[72]=u+-2;break}if(r[72]=u+((l?6:4)<<1),(d(1)|0)<<16>>16!=123){r[72]=u;break}l=r[72]|0,o=l;e:for(;;){switch(r[72]=o+2,o=d(1)|0,o<<16>>16){case 39:{R(39),r[72]=(r[72]|0)+2,o=d(1)|0;break}case 34:{R(34),r[72]=(r[72]|0)+2,o=d(1)|0;break}default:o=F(o)|0}if(o<<16>>16!=58){E=22;break}switch(r[72]=(r[72]|0)+2,(d(1)|0)<<16>>16){case 39:{R(39);break}case 34:{R(34);break}default:{E=26;break e}}switch(r[72]=(r[72]|0)+2,(d(1)|0)<<16>>16){case 125:{E=31;break e}case 44:break;default:{E=30;break e}}if(r[72]=(r[72]|0)+2,(d(1)|0)<<16>>16==125){E=31;break}o=r[72]|0}if((E|0)==22){r[72]=u;break}else if((E|0)==26){r[72]=u;break}else if((E|0)==30){r[72]=u;break}else if((E|0)==31){E=r[63]|0,r[E+16>>2]=l,r[E+12>>2]=(r[72]|0)+2;break}}while(!1)}h(j,"u");function kt(t){t=t|0;e:do switch(f[t>>1]|0){case 100:switch(f[t+-2>>1]|0){case 105:{t=N(t+-4|0,104,2)|0;break e}case 108:{t=N(t+-4|0,108,3)|0;break e}default:{t=0;break e}}case 101:switch(f[t+-2>>1]|0){case 115:switch(f[t+-4>>1]|0){case 108:{t=X(t+-6|0,101)|0;break e}case 97:{t=X(t+-6|0,99)|0;break e}default:{t=0;break e}}case 116:{t=N(t+-4|0,114,4)|0;break e}case 117:{t=N(t+-4|0,122,6)|0;break e}default:{t=0;break e}}case 102:{if((f[t+-2>>1]|0)==111&&(f[t+-4>>1]|0)==101)switch(f[t+-6>>1]|0){case 99:{t=N(t+-8|0,134,6)|0;break e}case 112:{t=N(t+-8|0,146,2)|0;break e}default:{t=0;break e}}else t=0;break}case 107:{t=N(t+-2|0,150,4)|0;break}case 110:{t=t+-2|0,X(t,105)|0?t=1:t=N(t,158,5)|0;break}case 111:{t=X(t+-2|0,100)|0;break}case 114:{t=N(t+-2|0,168,7)|0;break}case 116:{t=N(t+-2|0,182,4)|0;break}case 119:switch(f[t+-2>>1]|0){case 101:{t=X(t+-4|0,110)|0;break e}case 111:{t=N(t+-4|0,190,3)|0;break e}default:{t=0;break e}}default:t=0}while(!1);return t|0}h(kt,"o");function ye(){var t=0,o=0,l=0,u=0;o=r[73]|0,l=r[72]|0;e:for(;;){if(t=l+2|0,l>>>0>=o>>>0){o=10;break}switch(f[t>>1]|0){case 96:{o=7;break e}case 36:{if((f[l+4>>1]|0)==123){o=6;break e}break}case 92:{t=l+4|0;break}default:}l=t}(o|0)==6?(t=l+4|0,r[72]=t,o=r[70]|0,u=f[400]|0,l=u&65535,r[o+(l<<3)>>2]=4,f[400]=u+1<<16>>16,r[o+(l<<3)+4>>2]=t):(o|0)==7?(r[72]=t,l=r[70]|0,u=(f[400]|0)+-1<<16>>16,f[400]=u,(r[l+((u&65535)<<3)>>2]|0)!=3&&U()):(o|0)==10&&(r[72]=t,U())}h(ye,"h");function d(t){t=t|0;var o=0,l=0,u=0;l=r[72]|0;e:do{o=f[l>>1]|0;t:do if(o<<16>>16!=47)if(t){if(_(o)|0)break;break e}else{if(re(o)|0)break;break e}else switch(f[l+2>>1]|0){case 47:{Qe();break t}case 42:{he(t);break t}default:{o=47;break e}}while(!1);u=r[72]|0,l=u+2|0,r[72]=l}while(u>>>0<(r[73]|0)>>>0);return o|0}h(d,"w");function ue(t,o,l,u){t=t|0,o=o|0,l=l|0,u=u|0;var E=0,B=0;B=r[67]|0,r[67]=B+36,E=r[63]|0,r[(E|0?E+32|0:236)>>2]=B,r[64]=E,r[63]=B,r[B+8>>2]=t,(u|0)==2?(t=3,E=l):(E=(u|0)==1,t=E?1:2,E=E?l+2|0:0),r[B+12>>2]=E,r[B+28>>2]=t,r[B>>2]=o,r[B+4>>2]=l,r[B+16>>2]=0,r[B+20>>2]=u,o=(u|0)==1,g[B+24>>0]=o&1,r[B+32>>2]=0,o|(u|0)==2&&(g[803]=1)}h(ue,"d");function R(t){t=t|0;var o=0,l=0,u=0,E=0;for(E=r[73]|0,o=r[72]|0;;){if(u=o+2|0,o>>>0>=E>>>0){o=9;break}if(l=f[u>>1]|0,l<<16>>16==t<<16>>16){o=10;break}if(l<<16>>16==92)l=o+4|0,(f[l>>1]|0)==13?(o=o+6|0,o=(f[o>>1]|0)==10?o:l):o=l;else if(Se(l)|0){o=9;break}else o=u}(o|0)==9?(r[72]=u,U()):(o|0)==10&&(r[72]=u)}h(R,"v");function Le(t,o){t=t|0,o=o|0;var l=0,u=0,E=0,B=0;return l=r[72]|0,u=f[l>>1]|0,B=(t|0)==(o|0),E=B?0:t,B=B?0:o,u<<16>>16==97&&(r[72]=l+4,l=d(1)|0,t=r[72]|0,T(l)|0?(R(l),o=(r[72]|0)+2|0,r[72]=o):(F(l)|0,o=r[72]|0),u=d(1)|0,l=r[72]|0),(l|0)!=(t|0)&&q(t,o,E,B),u|0}h(Le,"A");function It(){var t=0,o=0,l=0;l=r[73]|0,o=r[72]|0;e:for(;;){if(t=o+2|0,o>>>0>=l>>>0){o=6;break}switch(f[t>>1]|0){case 13:case 10:{o=6;break e}case 93:{o=7;break e}case 92:{t=o+4|0;break}default:}o=t}return(o|0)==6?(r[72]=t,U(),t=0):(o|0)==7&&(r[72]=t,t=93),t|0}h(It,"C");function le(){var t=0,o=0,l=0;e:for(;;){if(t=r[72]|0,o=t+2|0,r[72]=o,t>>>0>=(r[73]|0)>>>0){l=7;break}switch(f[o>>1]|0){case 13:case 10:{l=7;break e}case 47:break e;case 91:{It()|0;break}case 92:{r[72]=t+4;break}default:}}(l|0)==7&&U()}h(le,"g");function pt(t){switch(t=t|0,f[t>>1]|0){case 62:{t=(f[t+-2>>1]|0)==61;break}case 41:case 59:{t=1;break}case 104:{t=N(t+-2|0,210,4)|0;break}case 121:{t=N(t+-2|0,218,6)|0;break}case 101:{t=N(t+-2|0,230,3)|0;break}default:t=0}return t|0}h(pt,"p");function he(t){t=t|0;var o=0,l=0,u=0,E=0,B=0;for(E=(r[72]|0)+2|0,r[72]=E,l=r[73]|0;o=E+2|0,!(E>>>0>=l>>>0||(u=f[o>>1]|0,!t&&Se(u)|0));){if(u<<16>>16==42&&(f[E+4>>1]|0)==47){B=8;break}E=o}(B|0)==8&&(r[72]=o,o=E+4|0),r[72]=o}h(he,"y");function J(t,o,l){t=t|0,o=o|0,l=l|0;var u=0,E=0;e:do if(!l)t=0;else{for(;u=g[t>>0]|0,E=g[o>>0]|0,u<<24>>24==E<<24>>24;)if(l=l+-1|0,l)t=t+1|0,o=o+1|0;else{t=0;break e}t=(u&255)-(E&255)|0}while(!1);return t|0}h(J,"m");function Ae(t){t=t|0;e:do switch(t<<16>>16){case 38:case 37:case 33:{t=1;break}default:if((t&-8)<<16>>16==40|(t+-58&65535)<6)t=1;else{switch(t<<16>>16){case 91:case 93:case 94:{t=1;break e}default:}t=(t+-123&65535)<4}}while(!1);return t|0}h(Ae,"I");function bt(t){t=t|0;e:do switch(t<<16>>16){case 38:case 37:case 33:break;default:if(!((t+-58&65535)<6|(t+-40&65535)<7&t<<16>>16!=41)){switch(t<<16>>16){case 91:case 94:break e;default:}return t<<16>>16!=125&(t+-123&65535)<4|0}}while(!1);return 1}h(bt,"U");function Ne(t){t=t|0;var o=0;o=f[t>>1]|0;e:do if((o+-9&65535)>=5){switch(o<<16>>16){case 160:case 32:{o=1;break e}default:}if(Ae(o)|0)return o<<16>>16!=46|(ge(t)|0)|0;o=0}else o=1;while(!1);return o|0}h(Ne,"x");function mt(t){t=t|0;var o=0,l=0,u=0,E=0;return l=p,p=p+16|0,u=l,r[u>>2]=0,r[66]=t,o=r[3]|0,E=o+(t<<1)|0,t=E+2|0,f[E>>1]=0,r[u>>2]=t,r[67]=t,r[59]=0,r[63]=0,r[61]=0,r[60]=0,r[65]=0,r[62]=0,p=l,o|0}h(mt,"S");function q(t,o,l,u){t=t|0,o=o|0,l=l|0,u=u|0;var E=0,B=0;E=r[67]|0,r[67]=E+20,B=r[65]|0,r[(B|0?B+16|0:240)>>2]=E,r[65]=E,r[E>>2]=t,r[E+4>>2]=o,r[E+8>>2]=l,r[E+12>>2]=u,r[E+16>>2]=0,g[803]=1}h(q,"O");function N(t,o,l){t=t|0,o=o|0,l=l|0;var u=0,E=0;return u=t+(0-l<<1)|0,E=u+2|0,t=r[3]|0,E>>>0>=t>>>0&&!(J(E,o,l<<1)|0)?(E|0)==(t|0)?t=1:t=Ne(u)|0:t=0,t|0}h(N,"$");function Kt(t){switch(t=t|0,f[t>>1]|0){case 107:{t=N(t+-2|0,150,4)|0;break}case 101:{(f[t+-2>>1]|0)==117?t=N(t+-4|0,122,6)|0:t=0;break}default:t=0}return t|0}h(Kt,"j");function X(t,o){t=t|0,o=o|0;var l=0;return l=r[3]|0,l>>>0<=t>>>0&&(f[t>>1]|0)==o<<16>>16?(l|0)==(t|0)?l=1:l=fe(f[t+-2>>1]|0)|0:l=0,l|0}h(X,"B");function fe(t){t=t|0;e:do if((t+-9&65535)<5)t=1;else{switch(t<<16>>16){case 32:case 160:{t=1;break e}default:}t=t<<16>>16!=46&(Ae(t)|0)}while(!1);return t|0}h(fe,"E");function Qe(){var t=0,o=0,l=0;t=r[73]|0,l=r[72]|0;e:for(;o=l+2|0,!(l>>>0>=t>>>0);)switch(f[o>>1]|0){case 13:case 10:break e;default:l=o}r[72]=o}h(Qe,"P");function F(t){for(t=t|0;!(_(t)|0||Ae(t)|0);)if(t=(r[72]|0)+2|0,r[72]=t,t=f[t>>1]|0,!(t<<16>>16)){t=0;break}return t|0}h(F,"q");function Dt(){var t=0;switch(t=r[(r[61]|0)+20>>2]|0,t|0){case 1:{t=-1;break}case 2:{t=-2;break}default:t=t-(r[3]|0)>>1}return t|0}h(Dt,"z");function yt(t){return t=t|0,!(N(t,196,5)|0)&&!(N(t,44,3)|0)?t=N(t,206,2)|0:t=1,t|0}h(yt,"D");function re(t){switch(t=t|0,t<<16>>16){case 160:case 32:case 12:case 11:case 9:{t=1;break}default:t=0}return t|0}h(re,"F");function ge(t){return t=t|0,(f[t>>1]|0)==46&&(f[t+-2>>1]|0)==46?t=(f[t+-4>>1]|0)==46:t=0,t|0}h(ge,"G");function P(t){return t=t|0,(r[3]|0)==(t|0)?t=1:t=Ne(t+-2|0)|0,t|0}h(P,"H");function Lt(){var t=0;return t=r[(r[62]|0)+12>>2]|0,t?t=t-(r[3]|0)>>1:t=-1,t|0}h(Lt,"J");function Nt(){var t=0;return t=r[(r[61]|0)+12>>2]|0,t?t=t-(r[3]|0)>>1:t=-1,t|0}h(Nt,"K");function St(){var t=0;return t=r[(r[62]|0)+8>>2]|0,t?t=t-(r[3]|0)>>1:t=-1,t|0}h(St,"L");function Jt(){var t=0;return t=r[(r[61]|0)+16>>2]|0,t?t=t-(r[3]|0)>>1:t=-1,t|0}h(Jt,"M");function Rt(){var t=0;return t=r[(r[61]|0)+4>>2]|0,t?t=t-(r[3]|0)>>1:t=-1,t|0}h(Rt,"N");function Ut(){var t=0;return t=r[61]|0,t=r[(t|0?t+32|0:236)>>2]|0,r[61]=t,(t|0)!=0|0}h(Ut,"Q");function vt(){var t=0;return t=r[62]|0,t=r[(t|0?t+16|0:240)>>2]|0,r[62]=t,(t|0)!=0|0}h(vt,"R");function U(){g[802]=1,r[68]=(r[72]|0)-(r[3]|0)>>1,r[72]=(r[73]|0)+2}h(U,"T");function _(t){return t=t|0,(t|128)<<16>>16==160|(t+-9&65535)<5|0}h(_,"V");function T(t){return t=t|0,t<<16>>16==39|t<<16>>16==34|0}h(T,"W");function xt(){return(r[(r[61]|0)+8>>2]|0)-(r[3]|0)>>1|0}h(xt,"X");function Ft(){return(r[(r[62]|0)+4>>2]|0)-(r[3]|0)>>1|0}h(Ft,"Y");function Se(t){return t=t|0,t<<16>>16==13|t<<16>>16==10|0}h(Se,"Z");function Mt(){return(r[r[61]>>2]|0)-(r[3]|0)>>1|0}h(Mt,"_");function Gt(){return(r[r[62]>>2]|0)-(r[3]|0)>>1|0}h(Gt,"ee");function Yt(){return m[(r[61]|0)+24>>0]|0|0}h(Yt,"ae");function Ht(t){t=t|0,r[3]=t}h(Ht,"re");function qt(){return r[(r[61]|0)+28>>2]|0}h(qt,"ie");function _t(){return(g[803]|0)!=0|0}h(_t,"se");function Ot(){return(g[804]|0)!=0|0}h(Ot,"fe");function jt(){return r[68]|0}h(jt,"te");function Xt(t){return t=t|0,p=t+992+15&-16,992}return h(Xt,"ce"),{su:Xt,ai:Jt,e:jt,ee:Ft,ele:Lt,els:St,es:Gt,f:Ot,id:Dt,ie:Rt,ip:Yt,is:Mt,it:qt,ms:_t,p:S,re:vt,ri:Ut,sa:mt,se:Nt,ses:Ht,ss:xt}}(typeof self<"u"?self:global,{},ne),Ie=y.su(z-(2<<17))}const i=L.length+1;y.ses(Ie),y.sa(i-1),_e(L,new Uint16Array(ne,Ie,i)),y.p()||(k=y.e(),M());const s=[],a=[];for(;y.ri();){const c=y.is(),C=y.ie(),Q=y.ai(),g=y.id(),f=y.ss(),r=y.se(),m=y.it();let K;y.ip()&&(K=pe(g===-1?c:c+1,L.charCodeAt(g===-1?c-1:c))),s.push({t:m,n:K,s:c,e:C,ss:f,se:r,d:g,a:Q})}for(;y.re();){const c=y.es(),C=y.ee(),Q=y.els(),g=y.ele(),f=L.charCodeAt(c),r=Q>=0?L.charCodeAt(Q):-1;a.push({s:c,e:C,ls:Q,le:g,n:f===34||f===39?pe(c+1,f):L.slice(c,C),ln:Q<0?void 0:r===34||r===39?pe(Q+1,r):L.slice(Q,g)})}return[s,a,!!y.f(),!!y.ms()]}h(CA,"parse");function pe(n,e){k=n;let A="",i=k;for(;;){k>=L.length&&M();const s=L.charCodeAt(k);if(s===e)break;s===92?(A+=L.slice(i,k),A+=EA(),i=k):(s===8232||s===8233||je(s)&&M(),++k)}return A+=L.slice(i,k++),A}h(pe,"b");function EA(){let n=L.charCodeAt(++k);switch(++k,n){case 110:return`
